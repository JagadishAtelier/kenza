              ...
              <div className='cart-drawer-text-price'>
                <div className='cart-drawer-item-text-div'>
                  <div className='cart-drawer-item-text'>
                    ...
                    <p>{quantity} x ₹{numericPrice.toFixed(2)} = ₹{(numericPrice * quantity).toFixed(2)}</p>
                  </div>
                </div>
                  ...
                  <div className="cart-item-quantity-container">
                    <div className="quantity-section">
                      <div className="quantity-box">
                        <button onClick={() => updateQuantity(product._id, 'dec')}>−</button>
                        <span>{quantity}</span>
                        <button onClick={() => updateQuantity(product._id, 'inc')}>+</button>
                      </div>
                    </div>
                  </div>
                </div>
